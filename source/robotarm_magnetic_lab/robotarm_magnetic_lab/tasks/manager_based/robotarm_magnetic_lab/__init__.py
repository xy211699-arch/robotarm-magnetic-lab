...
gym.register(
    id="Template-Robotarm-Magnetic-Local-Primitives-Flat-Lab-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.robotarm_magnetic_local_primitives_flat_env_cfg:"
...
gym.register(
    id="Template-Robotarm-Magnetic-Local-Primitives-Stomach-Lab-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.robotarm_magnetic_local_primitives_stomach_env_cfg:"
...
gym.register(
    id="Template-Robotarm-Magnetic-Eleven-Action-Flat-Lab-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.robotarm_magnetic_eleven_action_flat_env_cfg:"
